...
The Z-test is meant to wrap a set of mathematical values around an intiution we already understand: Democrats, most likely, feel differently about Trump than Republicans. Most likely, Democrats feel similarly enough to each other, and Republicans similarly enough to each other about Trump that using the sample mean will help us understand how the parties feel about Trump in a way that lets us adjudicate decisively whether they're the same or not!