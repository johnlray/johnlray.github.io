...
About 95\% of the time, our data falls within 1.96 standard deviations plus or minus the mean *if* it meets the assumption it typically needs to meet to be modeled using traditional methods.