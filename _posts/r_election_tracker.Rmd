...
grid.arrange(gov_gg_new, sh_gg_new, ss_gg_new, house_gg_new, ncol = 4, heights= rep(0.5, 4))
```

```{r echo = FALSE, warning = FALSE}
grid.arrange(gov_gg, sh_gg, ss_gg, house_gg, ncol = 4, heights= rep(0.5, 4))
```

```{r echo = FALSE, warning = FALSE}
grid.arrange(gov_bar, sh_bar, ss_bar, house_bar, ncol = 4, heights= rep(0.5, 4))
```