...
g1 = grid.arrange(gov_gg_new, sh_gg_new, ss_gg_new, house_gg_new, ncol = 4)
ggsave(plot = g1, "~/johnlray.github.io/2017/11/07/figure/unnamed-chunk-3-1.png", height = 2.6, width = 8)
```

```{r echo = FALSE, warning = FALSE}
g2 = grid.arrange(gov_gg, sh_gg, ss_gg, house_gg, ncol = 4)
ggsave(plot = g2, "~/johnlray.github.io/2017/11/07/figure/unnamed-chunk-4-1.png", height = 2.6, width = 8)
```

```{r echo = FALSE, warning = FALSE}
g3 = grid.arrange(gov_bar, sh_bar, ss_bar, house_bar, ncol = 4)
ggsave(plot = g3, "~/johnlray.github.io/2017/11/07/figure/unnamed-chunk-5-1.png", height = 2.6, width = 8)
```