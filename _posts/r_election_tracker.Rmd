...
knitr::opts_chunk$set(
  fig.path = "~/johnlray.github.io/_posts/2017/11/07/2017-11-07-election_tracker/"
)
```
...
grid.arrange(gov_gg_new, gov_gg, gov_bar, sh_gg_new, sh_gg, sh_bar, ss_gg_new, ss_gg, ss_bar, house_gg_new, house_gg, house_bar, ncol = 3) %>% print()
```